...
export function seed(deck) {
  ...
  M.record('agent-ready', site, { summary: '88/100 (grade B)', metrics: { score: 88, grade: 'B', gradeNum: 4, blockedCrawlers: 0, blockedRetrieval: 0, blockedList: [], blockedRetrievalList: [], jsonLdValid: 3, likelyShell: 0, llmsTxt: 1 } });
  M.record('agent-ready', site, { summary: '86/100 (grade B)', metrics: { score: 86, grade: 'B', gradeNum: 4, blockedCrawlers: 0, blockedRetrieval: 0, blockedList: [], blockedRetrievalList: [], jsonLdValid: 3, likelyShell: 0, llmsTxt: 1 } });
  M.record('agent-ready', site, { summary: '68/100 (grade D)', metrics: { score: 68, grade: 'D', gradeNum: 2, blockedCrawlers: 2, blockedRetrieval: 1, blockedList: ['Claude-SearchBot', 'GPTBot'], blockedRetrievalList: ['Claude-SearchBot'], jsonLdValid: 0, likelyShell: 0, llmsTxt: 1 } });
