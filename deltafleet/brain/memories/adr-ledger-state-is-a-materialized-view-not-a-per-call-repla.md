...
summary: 25. Ledger state is a materialized view, not a per-call replay (v0.14, scalability). · pendingApprovals pending onEvent 25 14 1 10 0 apistate degrade effectively subsequent
tags: state, replay, call, event, ledger, materializ
pointers: 
