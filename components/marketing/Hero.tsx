        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p className="max-w-2xl mx-auto text-xl text-slate-600 mb-10 leading-relaxed">
                    Status Loop keeps everyone in sync without spending a single minute in the morning.
                </p>
                    ...
                    <div className="bg-white border-b border-slate-100 px-6 py-3 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-2">
                                <div className="bg-indigo-600 p-1 rounded-md overflow-hidden">
                                    <img src="/icon.png" alt="Status Loop Logo" className="w-4 h-4 object-cover" />
                                </div>
